...
3. Browser check, executable procedure: screenshot every changed route into `.aiwork/{task}/screenshots/` (gitignored — working evidence, not repository content), and list the screenshot paths in implementation-notes and the final report.
