<template>
  <PageWrapper root-element="article" class="p-prose">
    ...
    <ul>
      <li>jak se o&nbsp;jídle mluví,</li>
      <li>jak se s&nbsp;ním pracuje v&nbsp;běžném provozu,</li>
      <li>jaké signály dostávají od dospělých,</li>
      <li>zda je škola v&nbsp;souladu s&nbsp;tím, co sama učí.</li>
    </ul>

    <p>Pokud se o&nbsp;zdraví učí v&nbsp;hodině, ale:</p>
    ...
    <p>pak se dobrý záměr míjí účinkem.</p>
    ...
    <p>
      Inovace v&nbsp;oblasti zdraví dětí neznamená nové projekty každý rok.<br />
      Znamená:
    </p>

    <ul>
      <li>jednotnou vizi,</li>
      <li>metodickou oporu škol,</li>
      <li>podporu kompetencí dospělých,</li>
