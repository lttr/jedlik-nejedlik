<template>
  <PageWrapper class="webinar-page p-page-layout">
    <!-- Hero -->
    ...
    <section class="learn-section p-full-bg">
      <div class="section-content">
        ...
        <ul class="check-list">
          <li>proč vaše dítě nereaguje tak, jak čekáte</li>
    ...
    <!-- After -->
    <section class="after-section p-full-bg">
      <div class="section-content">
        <h2 class="section-title">Co bude po webináři jiné:</h2>
        <ul class="check-list">
    ...
    <!-- For whom -->
    <section class="for-whom-section p-full-bg">
      <div class="section-content">
    ...
    <!-- What you get + bonus -->
    <section class="get-section p-full-bg">
      <div class="section-content">
    ...
    <section class="pricing-section p-full-bg">
      <div class="section-content">
        <h2 class="pricing-title">Cena</h2>
        <div class="price-box">
    ...
    <section class="faq-section p-full-bg">
      <div class="section-content">
        <h2 class="section-title">Možná vás napadá&hellip;</h2>
        <div class="faq-list">
    ...
    <!-- Final CTA -->
    <section class="final-cta-section p-full-bg">
      <div class="section-content">
...
.for-whom-card--yes h3 {
  color: var(--color-forest-green);
}

.for-whom-card--yes li::before {
  content: "✓";
  position: absolute;
  left: 0;
  color: var(--color-forest-green);
