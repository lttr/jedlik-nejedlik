  ...
  <PageWrapper class="prevence">
    ...
    <section class="intro-section p-prose">
      ...
      <ul class="intro-list">
        ...
        <li>způsob komunikace o&nbsp;jídle</li>
        <li>režim dne</li>
        <li>výživa, pohyb, spánek, vztahy…</li>
      </ul>
    </section>
    ...
    <section class="prevention-section p-prose">
      ...
      <ul>
        <li>v&nbsp;plném zdraví, v&nbsp;síle, odolnosti a&nbsp;funkčnosti</li>
    ...
    <section class="proto-section p-prose">
      ...
      <ul>
        <li>
          <strong>šíříme</strong> na našich sociálních sítích
    ...
    <section class="newsletter">
      <NewsletterForm
        ...
        description="Zdravé svačinky pro mého školáka"
        highlight="Vyplňte e-mail a&nbsp;materiál je váš."
        button-text="Získat materiál"
        redirect-path="/dekujeme-za-zajem-o-newsletter?pdf=zdrave-svacinky"
      >
        <div class="thumbnail">
          <img
            src="/img/svaciny-tahak-nahled.jpg"
            width="240"
            alt="Náhled materiálu Zdravé svačinky pro mého školáka"
            class="thumbnail-img"
          />
        </div>
      </NewsletterForm>
      <p class="stob-attribution">
        Materiál od našich kolegů z&nbsp;organizace STOB, s.&nbsp;r.&nbsp;o.
      </p>
    </section>

    <!-- Consultation offer -->
    <section class="consultation-section p-prose">
    ...
    <!-- Values -->
    <section class="values-section p-prose">
    ...
    <!-- InBody measurement -->
    <section class="inbody-section p-prose">
      <h2>Měření na přístroji InBody 270</h2>
      <p>Přístroj zjišťuje:</p>
      <ul>
        <li>viscerální tuk</li>
        <li>celková voda v&nbsp;těle</li>
        <li>kostní/nekostní minerály</li>
        <li>tuková hmota</li>
        <li>kostní hmota</li>
        <li>svalová hmota</li>
      ...
      <div class="inbody-pricing">
        <div class="inbody-price">
          <p class="price">250&nbsp;Kč / 10&nbsp;minut</p>
          <p>bez interpretace výsledků</p>
        </div>
        <div class="inbody-price">
          <p class="price">500&nbsp;Kč / 20&nbsp;minut</p>
...
.consultation-questions li:last-child {
  border-bottom: none;
}
