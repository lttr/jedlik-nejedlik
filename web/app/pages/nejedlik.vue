<template>
  <PageWrapper class="nejedlik">
    ...
    <!-- Společně zpět k pohodě -->
    <section class="together-section p-prose">
      <h2>Společně zpět k&nbsp;pohodě u&nbsp;stolu</h2>
      <p>
        Ať už je vaše situace jakákoliv,
    ...
    <!-- Jak pracujeme -->
    <section class="method-section p-prose">
      <h2>Jak pracujeme</h2>
      <p>V&nbsp;Jedlíkovi-Nejedlíkovi věříme, že:</p>
      <ul class="values-list">
        <li>jídlo je dovednost, která se vyvíjí v&nbsp;čase,</li>
        <li>nátlakové metody ničí u&nbsp;dítěte vztah k&nbsp;jídlu,</li>
        <li>každá situace má řešení.</li>
      </ul>
      <p>
        <strong>
    ...
    <section class="expect-section p-prose">
      <h2>Co od nás můžete očekávat</h2>
      <p>Výživa dětí je naším srdcovým tématem.</p>
      <p>Během konzultací propojujeme:</p>
      <ul>
        <li><strong>výživu</strong>,</li>
        <li><strong>výchovné principy</strong>,</li>
    ...
    <section class="consultation-section p-prose">
      <h2>Jak konzultace probíhá</h2>
      <p>Nejdříve potřebujeme porozumět vaší konkrétní situaci.</p>
